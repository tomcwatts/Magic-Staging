                  ...
                  {result.success ? (
                    <div className="space-y-3">
                      ...
                      <div className="p-3 bg-green-50 rounded-lg">
                        <p className="text-sm">
                          🎉 <strong>Awesome!</strong> {result.analysis}
                        </p>
                      </div>
                      ...
                      <div className="space-y-4">
                        ...
                        {result.stagedImage && (
                          <div className="space-y-2">
                            <Label>🪄 AI Staged Room:</Label>
                            <div className="relative w-full h-48 rounded-lg overflow-hidden border border-green-300">
                              <Image
                        ...
                        {result.success && !result.stagedImage && (
                          <div className="p-3 bg-blue-50 rounded-lg">
                            <p className="text-sm text-blue-800">
                              <strong>Note:</strong> Image generation might not be available with the current Gemini model. 
                              Check server logs for detailed staging analysis instead.
                            </p>
                          </div>
                        )}
                      </div>
